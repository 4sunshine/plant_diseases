...
def build_classifiers():
    ...
    classifiers['decision_tree'] = DecisionTreeClassifier(random_state=0,
                                                          splitter='best', criterion='entropy', max_depth=3)
    classifiers['svm'] = SVC(gamma='auto', kernel='linear', C=5, shrinking=True)
    classifiers['random_forest'] = RandomForestClassifier(max_depth=10, random_state=0,
                                                          criterion='entropy', n_jobs=8, n_estimators=250)
    classifiers['knn'] = KNeighborsClassifier(n_neighbors=11, n_jobs=8, metric='euclidean')
    classifiers['1_layer_mlp'] = MLPClassifier(activation='relu', alpha=0.0001, batch_size='auto',
...
def classification_results(classifiers, train_file, test_file):
...
if __name__ == '__main__':
    ...
    data, best_classifier = classification_results(classifiers, train_file, test_file)
